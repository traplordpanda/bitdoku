...
hidden if the `bitdoku_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `bitdoku_DEVELOPER_MODE` to the configure
...
Runs the executable target `bitdoku_exe`.
