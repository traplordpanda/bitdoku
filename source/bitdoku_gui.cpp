...
void SudokuVisualizer::drawNumbers() {
    const auto board = solver.to_string();
    for (int i = 0; i < BOARD_SIZE * BOARD_SIZE; ++i) {
        ...
        if (cellValue != '0') {
            ...
            text.setPosition(col * cellSize + cellSize / 4,
